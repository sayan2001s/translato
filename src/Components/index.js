...
export const nav_items = [
    { name: "Text to Text", navigate: "/user/text-to-text" },
    { name: "Text to Audio", navigate: "/user/text-to-voice" },
    { name: "Audio to Text", navigate: "/user/voice-to-text" },
    { name: "Audio to Audio", navigate: "/user/audio-to-audio" },
]

export const main_nav_items = [
    { name: "Home", navigate: "/" },
    { name: "About", navigate: "/about" },
    { name: "Services", navigate: "/service" },
